...
export const seriesData: Series[] = [
  {
    ...
    description: 'A suspenseful journey through shadows and mystery. Each act unfolds new secrets as the night holds its breath, guiding you deeper into dreamland.',
    color: '#4A5568',
    narrator: 'Rachel',
    chapterCount: 1,
    totalDuration: 6,
