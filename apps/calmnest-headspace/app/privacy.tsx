    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.paragraph}>
          CalmNest ("we," "our," or "us"), operated by Aiden Hyun, is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application (the "App"). Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the App.
        </Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          If you choose to link, connect, or log in to CalmNest using a third-party service (Google, Apple), we receive information from that service as permitted by your settings with that service. This may include your name, email address, and profile picture.
        </Text>
