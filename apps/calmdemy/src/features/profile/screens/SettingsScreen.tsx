...
import { useTheme, ThemeMode } from '@core/providers/contexts/ThemeContext';
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {/* Version */}
        <Text style={styles.version}>Calmdemy v1.0.0</Text>
      </ScrollView>
    </SafeAreaView>
  );
}

const createStyles = (theme: ReturnType<typeof import('@/theme').createTheme>) =>
  StyleSheet.create({
    safeArea: {
      flex: 1,
