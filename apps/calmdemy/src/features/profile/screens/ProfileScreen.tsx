      ...
      >
        ...
        <AnimatedView delay={50} duration={500}>
          {isPremium ? (
            ...
            <AnimatedPressable onPress={openPaywall} style={styles.upgradeBanner}>
        ...
        <AnimatedPressable onPress={navigateToStats} style={styles.sanctuaryCard}>
          ...
          {nextMilestone && (
            ...
            <View style={styles.nextMilestone}>
              ...
              <Text style={styles.nextMilestoneText}>
                {nextMilestone.days - (stats?.longest_streak || 0)} days until {nextMilestone.label.toLowerCase()}
              </Text>
            </View>
            </AnimatedView>
          )}
        ...
        <View style={styles.section}>
          <AnimatedView delay={650} duration={400}>
            ...
            <View style={styles.actionsCard}>
              <AnimatedPressable onPress={navigateToStats} style={styles.actionItem}>
              ...
              <AnimatedPressable onPress={navigateToDownloads} style={styles.actionItem}>
                <View style={styles.actionLeft}>
              ...
              <AnimatedPressable onPress={navigateToSettings} style={styles.actionItem}>
                <View style={styles.actionLeft}>
        ...
        <AnimatedView delay={700} duration={400}>
          {isAnonymous ? (
            <AnimatedPressable style={styles.signInButton} onPress={navigateToLogin}>
              <Ionicons 
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Calmdemy v1.0.0</Text>
