...
const ambientSounds = [
  ...
  { id: 'waves', icon: 'water-outline' as const, label: 'Waves', color: '#6B8FA1' },
  { id: 'fire', icon: 'flame-outline' as const, label: 'Fire', color: '#C4A77D' },
  { id: 'wind', icon: 'leaf-outline' as const, label: 'Wind', color: '#8BA88F' },
  { id: 'birds', icon: 'musical-notes-outline' as const, label: 'Birds', color: '#A8B4C4' },
  { id: 'thunder', icon: 'thunderstorm-outline' as const, label: 'Thunder', color: '#9A8FAE' },
];
            ...
            <AnimatedView delay={0} duration={500}>
              <View style={styles.header}>
                <View style={styles.moonContainer}>
                  <Ionicons name="moon" size={48} color={theme.colors.sleepAccent} />
                </View>
              ...
              {loading ? (
                <AnimatedView delay={150} duration={400}>
                  <View style={styles.featuredSkeleton}>
                    <Skeleton height={200} borderRadius={theme.borderRadius.xl} />
                  </View>
                </AnimatedView>
              ) : featuredStory ? (
                <AnimatedView delay={150} duration={400}>
                  ...
                  >
                    ...
                    >
                      <View style={styles.featuredStars}>
                        <Ionicons name="sparkles" size={24} color={theme.colors.sleepAccent} />
                      </View>
                    ...
                    >
                      ...
                      {selectedSound === sound.id && (
                        <View style={styles.soundPlaying}>
                          <Ionicons name="volume-high" size={14} color={theme.colors.sleepAccent} />
                        </View>
                      )}
                    </AnimatedPressable>
                  </AnimatedView>
                  ...
                  >
                    {[0, 1, 2].map((i) => (
                      <View key={i} style={styles.storyCard}>
                        <Skeleton height={80} borderRadius={theme.borderRadius.md} style={{ marginBottom: theme.spacing.sm }} />
            ...
            <View style={styles.section}>
              ...
              <AnimatedView delay={750} duration={400}>
                <View style={styles.tipsCard}>
                  {[
                    { icon: 'thermometer-outline' as const, title: 'Cool room', text: '65-68°F is ideal for sleep', color: '#7B9BAE' },
                    { icon: 'phone-portrait-outline' as const, title: 'Screen-free', text: '30 min before bed', color: '#A8B4C4' },
                    { icon: 'time-outline' as const, title: 'Consistent schedule', text: 'Same time each night', color: '#C4A77D' },
                  ].map((tip, index) => (
