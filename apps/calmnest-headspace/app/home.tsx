  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Welcome to CalmNest</Text>
        <Text style={styles.subtitle}>Your meditation sanctuary</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>Sleep Stories</Text>
        </TouchableOpacity>
      </View>
