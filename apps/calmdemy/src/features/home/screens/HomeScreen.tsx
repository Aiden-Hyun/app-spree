...
import { parseSessionCode } from '@shared/utils/courseCodeParser';
import { ResolvedContent } from '../data/homeRepository';
        ...
        <View style={styles.section}>
          ...
          <AnimatedView delay={450} duration={400}>
            {statsLoading ? (
              ...
              <AnimatedPressable onPress={navigateToStats} style={styles.journeyCard}>
            <View style={styles.streakRow}>
