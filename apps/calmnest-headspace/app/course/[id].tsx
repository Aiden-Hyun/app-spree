    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <AnimatedView delay={0} duration={400}>
          <LinearGradient
            colors={[`${course.color}30`, `${course.color}10`, 'transparent']}
            style={styles.heroGradient}
          >
            <View style={[styles.heroIcon, { backgroundColor: `${course.color}25` }]}>
              <Ionicons name="school" size={48} color={course.color} />
            </View>
            <Text style={styles.courseTitle}>{course.title}</Text>
            <View style={styles.courseMeta}>
              <View style={styles.metaItem}>
                <Ionicons name="layers-outline" size={16} color={theme.colors.textLight} />
              ...
              <View style={styles.metaItem}>
                <Ionicons name="fitness-outline" size={16} color={theme.colors.textLight} />
        ...
        <View style={styles.sessionsContainer}>
          ...
          {course.sessions.map((session, index) => (
            <AnimatedView key={session.id} delay={150 + index * 50} duration={300}>
              <AnimatedPressable
                onPress={() => handleSessionPress(session)}
                style={styles.sessionCard}
              >
                <View style={[styles.sessionNumber, { backgroundColor: `${course.color}20` }]}>
                  <Text style={[styles.sessionNumberText, { color: course.color }]}>
                    {session.dayNumber}
                  </Text>
                </View>
