    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.paragraph}>
          Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the CalmNest mobile application (the "Service") operated by Aiden Hyun ("us", "we", or "our").
        </Text>
        ...
        <Text style={styles.paragraph}>
          By downloading, installing, accessing, or using CalmNest ("the App"), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, you must immediately cease all use of the App and delete it from your device.
        </Text>
        ...
        <Text style={styles.paragraph}>
          We do not recommend or endorse any specific tests, physicians, products, procedures, opinions, or other information that may be mentioned in the App. Reliance on any information provided by CalmNest is solely at your own risk.
        </Text>
