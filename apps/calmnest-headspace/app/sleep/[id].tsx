  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.safeArea}>
        <LinearGradient colors={['#1A1D29', '#2A2D3E', '#3D4158']} style={styles.gradient}>
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <View style={styles.iconContainer}>
            {story.thumbnail_url ? (
              <Image source={{ uri: story.thumbnail_url }} style={styles.thumbnailImage} />
            ) : (
              <View style={styles.iconCircle}>
                <Ionicons name={getCategoryIcon()} size={64} color={theme.colors.sleepAccent} />
              </View>
            )}
          </View>
          ...
          <View style={styles.storyInfo}>
            ...
            <View style={styles.metaRow}>
              <View style={styles.metaItem}>
                ...
                <Text style={styles.metaText}>{story.duration_minutes} min</Text>
              </View>
              <View style={styles.metaItem}>
                <Ionicons name="mic-outline" size={16} color={theme.colors.sleepTextMuted} />
                <Text style={styles.metaText}>{story.narrator}</Text>
              </View>
            </View>
          </View>
